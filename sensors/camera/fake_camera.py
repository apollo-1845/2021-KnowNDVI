...
class FakeCamera(Sensor):
    ...
    def set_image_by_id(self, img_id: int):
    ...
    def capture_data(self):
        ...
        print(f"Using an online image {self.current_picture_id}")
        self.set_image_by_id(self.current_picture_id)
        # we need to get a number 1-250 inclusive, so wrap around and increment
        self.current_picture_id = self.current_picture_id % 250 + 1
